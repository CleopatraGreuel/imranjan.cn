...
import { _ as _sfc_main$2 } from "./NuxtImg-DyBEv8HO.js";
import { ref, mergeProps, unref, useSSRContext, computed, watch, nextTick } from "vue";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "code-block-container" }, _attrs))} data-v-e3db92c8><div class="code-summary" data-v-e3db92c8><div class="summary-content" data-v-e3db92c8><h4 class="code-title" data-v-e3db92c8>${ssrInterpolate(__props.title)}</h4>`);
      if (__props.description) {
        _push(`<p class="code-description" data-v-e3db92c8>${ssrInterpolate(__props.description)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="code-info" data-v-e3db92c8><span class="language-tag" data-v-e3db92c8>${ssrInterpolate(__props.language)}</span>`);
      if (__props.complexity) {
        _push(`<span class="complexity-tag" data-v-e3db92c8>${ssrInterpolate(__props.complexity)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><button class="${ssrRenderClass([{ expanded: unref(isExpanded) }, "code-toggle-btn"])}" data-v-e3db92c8><span data-v-e3db92c8>${ssrInterpolate(unref(isExpanded) ? "收起代码" : "查看代码")}</span><svg class="${ssrRenderClass([{ rotated: unref(isExpanded) }, "toggle-icon"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-e3db92c8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-e3db92c8></path></svg></button></div><div style="${ssrRenderStyle(unref(isExpanded) ? null : { display: "none" })}" class="code-content-wrapper" data-v-e3db92c8><div class="code-header" data-v-e3db92c8><span class="file-name" data-v-e3db92c8>${ssrInterpolate(__props.fileName || "code." + __props.language)}</span><div class="code-actions" data-v-e3db92c8><button class="${ssrRenderClass([{ copied: unref(justCopied) }, "copy-btn"])}" data-v-e3db92c8>${ssrInterpolate(unref(justCopied) ? "已复制" : "复制")}</button>`);
      if (__props.githubUrl) {
        _push(`<a${ssrRenderAttr("href", __props.githubUrl)} target="_blank" class="github-btn" data-v-e3db92c8><svg class="github-icon" fill="currentColor" viewBox="0 0 24 24" data-v-e3db92c8><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" data-v-e3db92c8></path></svg> GitHub </a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="code-content" data-v-e3db92c8><pre class="code-pre" data-v-e3db92c8><code class="${ssrRenderClass(`language-${__props.language}`)}" data-v-e3db92c8>${ssrInterpolate(__props.code)}</code></pre></div></div></div>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e3db92c8"]]);
const _imports_0 = publicAssetsURL("/images/projects/yigui-app-2025/App截图/设计页3_设计结果展示.PNG");
const _imports_1 = publicAssetsURL("/videos/projects/yigui-app-2025/在模拟机完整操作视频.webm");
const _imports_2 = publicAssetsURL("/images/projects/mengsheng-2024/cover.jpg");
const _imports_3 = publicAssetsURL("/images/projects/mengsheng-2024/外框架3D建模展示.mp4");
const _imports_4 = publicAssetsURL("/images/projects/mengsheng-2024/debug-video-1.mp4");
const _imports_5 = publicAssetsURL("/images/projects/mengsheng-2024/debug-video-2.mp4");
const _imports_6 = publicAssetsURL("/images/projects/led-voice-2025/vid-poster.png");
const _imports_7 = publicAssetsURL("/images/projects/led-voice-2025/demo-video.mp4");
const _imports_8 = publicAssetsURL("/images/projects/restaurant-system-2025/首页_导航栏展开.png");
const _imports_9 = publicAssetsURL("/images/projects/restaurant-system-2025/restaurant-system-demo.mp4");
  ...
  setup(__props) {
    ...
    const projects2 = ref([
      ...
      },
      {
        ...
        badges: [
          { text: "SwiftUI", type: "badge-primary" },
          { text: "CoreML", type: "badge-info" },
          { text: "Blender", type: "badge-secondary" }
        ],
        stats: [
          { value: "个人项目", label: "独立完成" }
        ]
      },
      {
      ...
      },
      {
        ...
        hasDetails: true,
        icon: "🧠",
        coverImage: "/images/projects/nlp-sentiment-2024/cover.png",
        description: "基于BERT模型的中文情感分析系统，支持微博、评论等社交媒体文本的情感倾向识别",
        badges: [
          { text: "PyTorch", type: "badge-primary" },
          { text: "BERT模型", type: "badge-info" },
          { text: "NLP", type: "badge-accent" }
        ],
        stats: [
          { value: "94.2%", label: "准确率" },
          { value: "10万+", label: "训练样本" }
        ]
      },
      {
        id: "react-dashboard-2024",
        title: "React数据可视化平台",
        year: 2024,
        category: "Web开发",
        status: "completed",
        hasDetails: true,
        icon: "📊",
        coverImage: "/images/projects/react-dashboard-2024/cover.png",
        description: "基于React的企业级数据可视化平台，支持实时数据监控、图表展示和业务分析",
        badges: [
          { text: "React", type: "badge-primary" },
          { text: "TypeScript", type: "badge-info" },
          { text: "D3.js", type: "badge-secondary" }
        ],
        stats: [
          { value: "15+", label: "图表组件" },
      ...
      },
      {
        ...
        hasDetails: true,
        icon: "⛏️",
        coverImage: "/images/projects/data-mining-2024/cover.png",
        description: "运用聚类分析、时间序列分析等数据挖掘技术，深度分析客户行为模式和消费习惯",
        badges: [
          { text: "Python", type: "badge-primary" },
          { text: "scikit-learn", type: "badge-info" },
          { text: "Pandas", type: "badge-accent" }
        ],
        stats: [
          { value: "5类", label: "客户分群" },
          { value: "85%", label: "预测准确率" }
        ]
      }
    ]);
    const filteredProjects = computed(() => {
      if (selectedCategory.value === "all") {
        return projects2.value;
      }
      if (selectedCategory.value === "completed") {
        return projects2.value.filter((project) => project.status === "completed");
      }
      if (selectedCategory.value === "ongoing") {
        return projects2.value.filter((project) => project.status === "ongoing");
      }
      return projects2.value;
    });
    ...
    const triggerCardAnimations = () => {
      nextTick(() => {
        const cards = (void 0).querySelectorAll(".project-card");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CodeBlock = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "projects-page" }, _attrs))} data-v-50f125ac>`);
      _push(ssrRenderComponent(_component_PageHeader, null, null, _parent));
      _push(`<main class="main-content" data-v-50f125ac>`);
      if (!selectedProject.value) {
        _push(`<section class="projects-overview" data-v-50f125ac><div class="category-selector" data-v-50f125ac><div class="category-buttons" data-v-50f125ac><button class="${ssrRenderClass(["category-btn", { active: selectedCategory.value === "all" }])}" data-v-50f125ac> 全部 </button><button class="${ssrRenderClass(["category-btn", { active: selectedCategory.value === "completed" }])}" data-v-50f125ac> 已完成 </button><button class="${ssrRenderClass(["category-btn", { active: selectedCategory.value === "ongoing" }])}" data-v-50f125ac> 进行中 </button></div></div>`);
        if (filteredProjects.value.length > 0) {
          _push(`<div class="projects-grid" data-v-50f125ac><!--[-->`);
          ssrRenderList(filteredProjects.value, (project) => {
            _push(`<article class="project-card" data-v-50f125ac><div class="card-image" data-v-50f125ac>`);
            if (project.coverImage) {
              ...
              _push(`<div class="placeholder-image" data-v-50f125ac><div class="placeholder-icon" data-v-50f125ac>${ssrInterpolate(project.icon)}</div><span class="placeholder-text" data-v-50f125ac>${ssrInterpolate(project.category)}</span></div>`);
            }
            _push(`<div class="card-overlay" data-v-50f125ac><span class="view-details" data-v-50f125ac>${ssrInterpolate(project.hasDetails ? "查看详情" : "敬请期待")}</span></div></div><div class="card-content" data-v-50f125ac><div class="card-header" data-v-50f125ac><h3 class="card-title" data-v-50f125ac>${ssrInterpolate(project.title)}</h3><span class="card-year" data-v-50f125ac>${ssrInterpolate(project.year)}年</span></div><p class="card-description" data-v-50f125ac>${ssrInterpolate(project.description)}</p><div class="card-badges" data-v-50f125ac><!--[-->`);
            ssrRenderList(project.badges, (badge) => {
              _push(`<span class="${ssrRenderClass(["badge", badge.type])}" data-v-50f125ac>${ssrInterpolate(badge.text)}</span>`);
            });
            _push(`<!--]--></div>`);
            if (project.stats) {
              _push(`<div class="card-stats" data-v-50f125ac><!--[-->`);
              ssrRenderList(project.stats, (stat) => {
                _push(`<div class="stat" data-v-50f125ac><span class="stat-value" data-v-50f125ac>${ssrInterpolate(stat.value)}</span><span class="stat-label" data-v-50f125ac>${ssrInterpolate(stat.label)}</span></div>`);
              });
              _push(`<!--]--></div>`);
            } else {
              _push(`<!---->`);
            ...
            if (!project.hasDetails) {
              _push(`<div class="card-status" data-v-50f125ac><span class="status-coming" data-v-50f125ac>详情即将更新</span></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div></article>`);
          ...
          _push(`<div class="empty-state" data-v-50f125ac><div class="empty-icon" data-v-50f125ac>📋</div><h3 class="empty-title" data-v-50f125ac>暂无${ssrInterpolate(getCategoryName())}项目</h3><p class="empty-description" data-v-50f125ac>该分类下暂时没有项目，请选择其他分类查看</p></div>`);
        }
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedProject.value === "mobile-app-2025") {
        _push(`<section class="project-detail" data-v-50f125ac><div class="back-button-container" data-v-50f125ac><button class="back-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg> 返回项目概览 </button></div><aside class="floating-nav" style="${ssrRenderStyle(selectedProject.value === "mobile-app-2025" ? null : { display: "none" })}" data-v-50f125ac><div class="floating-nav-content" data-v-50f125ac><div class="floating-nav-title" data-v-50f125ac>导航</div><nav class="floating-nav-items" data-v-50f125ac><a href="#team-info" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "team-info" }])}" data-v-50f125ac>团队信息</a><a href="#project-background" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "project-background" }])}" data-v-50f125ac>项目背景</a><a href="#ui-design" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "ui-design" }])}" data-v-50f125ac>界面设计</a><a href="#model-assets" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "model-assets" }])}" data-v-50f125ac>3D建模</a><a href="#system-architecture" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "system-architecture" }])}" data-v-50f125ac>系统架构</a><a href="#algorithm-ml" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "algorithm-ml" }])}" data-v-50f125ac>AI算法</a><a href="#backend-api" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "backend-api" }])}" data-v-50f125ac>后端API</a><a href="#demo-video" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "demo-video" }])}" data-v-50f125ac>演示视频</a><a href="#achievements" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "achievements" }])}" data-v-50f125ac>竞赛成果</a><a href="#project-summary" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "project-summary" }])}" data-v-50f125ac>项目总结</a></nav></div></aside><div class="project-header" data-v-50f125ac><div class="project-title-section" data-v-50f125ac><span class="project-date" data-v-50f125ac>2025年</span><h1 class="project-title" data-v-50f125ac>中国高校计算机大赛—移动应用创新赛</h1><h2 class="project-subtitle" data-v-50f125ac>Yigui / 依柜：个性化服装设计与虚拟试穿应用</h2><div class="project-badges" data-v-50f125ac><span class="badge badge-primary" data-v-50f125ac>SwiftUI</span><span class="badge badge-info" data-v-50f125ac>CoreML</span><span class="badge badge-secondary" data-v-50f125ac>Blender</span><span class="badge badge-accent" data-v-50f125ac>Python后端</span><span class="badge badge-warning" data-v-50f125ac>西南赛区二等奖</span></div></div></div><div id="team-info" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>团队信息</h3></div><div class="team-info-content" data-v-50f125ac><div class="team-info-grid" data-v-50f125ac><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>比赛名称</h4></div><div class="info-content" data-v-50f125ac><p data-v-50f125ac>中国高校计算机大赛—移动应用创新赛</p></div></div><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>指导方</h4></div><div class="info-content" data-v-50f125ac><p data-v-50f125ac>个人独立项目</p></div></div><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>团队成员</h4></div><ul class="team-members-list" data-v-50f125ac><li data-v-50f125ac>我 <span class="leader-badge" data-v-50f125ac>独立开发</span> - 产品设计、UI/UX、iOS开发、AI算法、后端系统、3D建模</li></ul></div></div></div></div><div id="project-background" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目背景与创新</h3></div><div class="background-content" data-v-50f125ac><div class="background-main-content" data-v-50f125ac><div class="background-description" data-v-50f125ac><p data-v-50f125ac> Yigui（依柜）项目源于对个性化服装设计与虚拟试穿技术的探索。在当前时尚产业数字化转型的背景下， 消费者对个性化定制和虚拟体验的需求日益增长。该项目旨在打造一个集成AI设计、虚拟试穿、 个性化推荐于一体的移动应用平台。 </p><div class="innovation-highlights" data-v-50f125ac><div class="highlight-card" data-v-50f125ac><div class="highlight-icon" data-v-50f125ac>🎨</div><h5 data-v-50f125ac>AI驱动设计</h5><p data-v-50f125ac>基于CoreML框架实现智能服装设计生成</p></div><div class="highlight-card" data-v-50f125ac><div class="highlight-icon" data-v-50f125ac>👕</div><h5 data-v-50f125ac>虚拟试穿</h5><p data-v-50f125ac>结合计算机视觉技术实现实时试穿效果</p></div><div class="highlight-card" data-v-50f125ac><div class="highlight-icon" data-v-50f125ac>📱</div><h5 data-v-50f125ac>移动优先</h5><p data-v-50f125ac>采用SwiftUI构建流畅的原生iOS体验</p></div><div class="highlight-card" data-v-50f125ac><div class="highlight-icon" data-v-50f125ac>🔧</div><h5 data-v-50f125ac>全栈实现</h5><p data-v-50f125ac>独立完成前端、后端、AI算法全部开发</p></div></div></div><div class="research-analysis" data-v-50f125ac><div class="analysis-grid" data-v-50f125ac><div class="analysis-card" data-v-50f125ac><h5 data-v-50f125ac>用户需求洞察</h5><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>同理心地图分析</span></div></div><div class="analysis-card" data-v-50f125ac><h5 data-v-50f125ac>竞品分析定位</h5><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>竞品雷达图</span></div></div></div></div></div></div></div><div id="ui-design" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>界面设计与用户体验</h3></div><div class="ui-design-content" data-v-50f125ac><div class="ui-main-content" data-v-50f125ac><div class="ui-description" data-v-50f125ac><p data-v-50f125ac> Yigui的界面设计注重用户体验的流畅性和功能的直观性。采用现代化的设计语言， 结合iOS设计规范，为用户提供简洁、优雅的虚拟试穿体验。从初始原型到最终实现， 每个界面元素都经过精心设计和用户测试优化。 </p><div class="figma-showcase" data-v-50f125ac><div class="info-header text-center mb-8" data-v-50f125ac><h4 data-v-50f125ac>Figma 原型与流程设计</h4></div><div class="figma-image-container" data-v-50f125ac><div class="gallery-item max-w-4xl mx-auto" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/Figma初步原型设计.png",
          alt: "Figma 初步原型",
          preset: "project",
          class: "feature-image clickable-image rounded-xl border border-gray-200 shadow-lg w-full",
          style: { objectFit: "contain" }
        }, null, _parent));
        _push(`<span class="gallery-caption text-center" data-v-50f125ac>Figma 初步原型设计 - 完整的用户界面设计与交互流程</span></div></div><div class="figma-highlights max-w-4xl mx-auto mt-6" data-v-50f125ac><div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-v-50f125ac><div class="figma-feature" data-v-50f125ac><h6 data-v-50f125ac>导航设计</h6><p data-v-50f125ac>Tab导航 + 分步流程，清晰的信息架构</p></div><div class="figma-feature" data-v-50f125ac><h6 data-v-50f125ac>状态管理</h6><p data-v-50f125ac>进度指示、按钮状态、草稿自动保存</p></div><div class="figma-feature" data-v-50f125ac><h6 data-v-50f125ac>组件复用</h6><p data-v-50f125ac>色板、图案库、参数面板统一设计</p></div></div></div></div><div class="ui-principles-overview" data-v-50f125ac><div class="ui-category" data-v-50f125ac><h4 data-v-50f125ac>设计原则</h4><div class="ui-items" data-v-50f125ac><span class="ui-item" data-v-50f125ac>简洁直观</span><span class="ui-item" data-v-50f125ac>一致性</span><span class="ui-item" data-v-50f125ac>反馈及时</span><span class="ui-item" data-v-50f125ac>易用性</span><span class="ui-item" data-v-50f125ac>美观性</span></div></div><div class="ui-category" data-v-50f125ac><h4 data-v-50f125ac>核心功能</h4><div class="ui-items" data-v-50f125ac><span class="ui-item" data-v-50f125ac>个性化设计</span><span class="ui-item" data-v-50f125ac>虚拟试穿</span><span class="ui-item" data-v-50f125ac>实时预览</span><span class="ui-item" data-v-50f125ac>参数调节</span><span class="ui-item" data-v-50f125ac>结果分享</span></div></div><div class="ui-category" data-v-50f125ac><h4 data-v-50f125ac>交互体验</h4><div class="ui-items" data-v-50f125ac><span class="ui-item" data-v-50f125ac>手势操作</span><span class="ui-item" data-v-50f125ac>动画过渡</span><span class="ui-item" data-v-50f125ac>触觉反馈</span><span class="ui-item" data-v-50f125ac>语音引导</span><span class="ui-item" data-v-50f125ac>智能推荐</span></div></div><div class="ui-category" data-v-50f125ac><h4 data-v-50f125ac>技术框架</h4><div class="ui-items" data-v-50f125ac><span class="ui-item" data-v-50f125ac>SwiftUI</span><span class="ui-item" data-v-50f125ac>Combine</span><span class="ui-item" data-v-50f125ac>CoreML</span><span class="ui-item" data-v-50f125ac>Vision</span><span class="ui-item" data-v-50f125ac>UIKit</span></div></div></div><div class="app-screenshots-showcase mt-12" data-v-50f125ac><div class="info-header text-center mb-8" data-v-50f125ac><h4 data-v-50f125ac>App界面展示</h4></div><div class="screenshots-grid" data-v-50f125ac><div class="screenshot-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/App截图/登录页面.PNG",
          alt: "登录页面",
          preset: "project",
          class: "screenshot-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="screenshot-caption" data-v-50f125ac>登录页面</span></div><div class="screenshot-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/App截图/设计页1_设计类型选择.PNG",
          alt: "设计类型选择",
          preset: "project",
          class: "screenshot-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="screenshot-caption" data-v-50f125ac>设计类型选择</span></div><div class="screenshot-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/App截图/设计页2_颜色图案配置.PNG",
          alt: "颜色图案配置",
          preset: "project",
          class: "screenshot-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="screenshot-caption" data-v-50f125ac>颜色图案配置</span></div><div class="screenshot-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/App截图/设计页3_设计结果展示.PNG",
          alt: "设计结果展示",
          preset: "project",
          class: "screenshot-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="screenshot-caption" data-v-50f125ac>设计结果展示</span></div><div class="screenshot-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/App截图/试穿页面_上传照片.PNG",
          alt: "试穿页面",
          preset: "project",
          class: "screenshot-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="screenshot-caption" data-v-50f125ac>试穿页面</span></div><div class="screenshot-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/App截图/试穿页面_试穿结果.PNG",
          alt: "试穿结果",
          preset: "project",
          class: "screenshot-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="screenshot-caption" data-v-50f125ac>试穿结果</span></div></div></div></div></div></div></div><div id="model-assets" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>3D建模与资源制作</h3></div><div class="work-content space-y-10" data-v-50f125ac><div class="info-card" data-v-50f125ac><div class="info-header text-center" data-v-50f125ac><h4 data-v-50f125ac>Blender 3D建模制作流程</h4></div><div class="info-content max-w-4xl mx-auto text-center" data-v-50f125ac><p class="text-lg leading-relaxed mb-8" data-v-50f125ac> 为了实现逼真的虚拟试穿效果，项目中自主制作了大量3D服装模型和人体模型。 使用Blender进行建模、材质制作和动画制作，确保模型在移动设备上的性能表现和视觉效果。 </p><div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8" data-v-50f125ac><div class="modeling-process" data-v-50f125ac><h5 class="process-title" data-v-50f125ac>建模流程</h5><p class="process-desc" data-v-50f125ac>基础网格 → 细节雕刻 → 拓扑优化 → UV展开</p></div><div class="modeling-process" data-v-50f125ac><h5 class="process-title" data-v-50f125ac>材质制作</h5><p class="process-desc" data-v-50f125ac>纹理绘制 → 材质节点 → 渲染测试 → 优化调整</p></div><div class="modeling-process" data-v-50f125ac><h5 class="process-title" data-v-50f125ac>移动端优化</h5><p class="process-desc" data-v-50f125ac>多边形简化 → 纹理压缩 → LOD层级 → 性能测试</p></div></div></div></div><div class="blender-showcase" data-v-50f125ac><div class="info-header text-center mb-8" data-v-50f125ac><h4 data-v-50f125ac>Blender 3D建模作品展示</h4></div><div class="blender-gallery-grid" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/Blender作品/服装建模1_休闲T恤.png",
          alt: "休闲T恤建模",
          preset: "project",
          class: "blender-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="gallery-caption text-center" data-v-50f125ac>休闲T恤 - 基础款式建模与材质制作</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/Blender作品/服装建模2_正式衬衫.png",
          alt: "正式衬衫建模",
          preset: "project",
          class: "blender-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="gallery-caption text-center" data-v-50f125ac>正式衬衫 - 商务风格建模设计</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/Blender作品/人体模型_男性.png",
          alt: "男性人体模型",
          preset: "project",
          class: "blender-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="gallery-caption text-center" data-v-50f125ac>男性人体模型 - 虚拟试穿基础模型</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/Blender作品/材质节点示例.png",
          alt: "材质节点编辑",
          preset: "project",
          class: "blender-image rounded-lg shadow-lg"
        }, null, _parent));
        _push(`<span class="gallery-caption text-center" data-v-50f125ac>材质节点编辑 - 复杂材质制作流程</span></div></div><div class="blender-highlights max-w-4xl mx-auto mt-6" data-v-50f125ac><div class="grid grid-cols-1 md:grid-cols-4 gap-6" data-v-50f125ac><div class="blender-feature" data-v-50f125ac><h6 data-v-50f125ac>多边形建模</h6><p data-v-50f125ac>低多边形基础建模，适合移动端渲染</p></div><div class="blender-feature" data-v-50f125ac><h6 data-v-50f125ac>材质节点</h6><p data-v-50f125ac>基于节点的复杂材质和纹理制作</p></div><div class="blender-feature" data-v-50f125ac><h6 data-v-50f125ac>UV展开</h6><p data-v-50f125ac>精确的UV映射，保证纹理质量</p></div><div class="blender-feature" data-v-50f125ac><h6 data-v-50f125ac>移动端优化</h6><p data-v-50f125ac>LOD层级设计，适配不同设备性能</p></div></div></div></div></div></div><div id="system-architecture" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>系统架构设计</h3></div><div class="work-content space-y-10" data-v-50f125ac><div class="info-card" data-v-50f125ac><div class="info-header text-center" data-v-50f125ac><h4 data-v-50f125ac>整体设计理念</h4></div><div class="info-content max-w-4xl mx-auto text-center" data-v-50f125ac><p class="text-lg leading-relaxed mb-6" data-v-50f125ac>前端采用 SwiftUI 构建，设备侧以 CoreML 完成本地推理与参数化渲染；后端部署于 Ubuntu，按&quot;用户/设计/渲染&quot;模块化拆分，提供鉴权、数据持久化与异步渲染任务管理。</p><div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8" data-v-50f125ac><div class="architecture-pillar" data-v-50f125ac><h5 class="pillar-title" data-v-50f125ac>移动端前端</h5><p class="pillar-desc" data-v-50f125ac>SwiftUI + CoreML<br data-v-50f125ac>本地推理与渲染</p></div><div class="architecture-pillar" data-v-50f125ac><h5 class="pillar-title" data-v-50f125ac>数据流转</h5><p class="pillar-desc" data-v-50f125ac>参数化设计数据<br data-v-50f125ac>HTTPS + JWT 安全传输</p></div><div class="architecture-pillar" data-v-50f125ac><h5 class="pillar-title" data-v-50f125ac>服务端后台</h5><p class="pillar-desc" data-v-50f125ac>Ubuntu 部署<br data-v-50f125ac>模块化微服务架构</p></div></div></div></div><div class="architecture-showcase" data-v-50f125ac><div class="info-header text-center mb-8" data-v-50f125ac><h4 data-v-50f125ac>系统架构全景图</h4></div><div class="architecture-image-container" data-v-50f125ac><div class="gallery-item max-w-5xl mx-auto" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>默认男模型材质节点</span></div></div><div class="model-item-content" data-v-50f125ac><ul class="list-disc pl-5 space-y-2 text-gray-700" data-v-50f125ac><li data-v-50f125ac><strong data-v-50f125ac>节点精简：</strong>只保留颜色、金属度、粗糙度、法线等关键通道</li><li data-v-50f125ac><strong data-v-50f125ac>PBR 优化：</strong>纹理叠加模拟布料质感，移动端表现稳定</li><li data-v-50f125ac><strong data-v-50f125ac>跨平台适配：</strong>减少 Linux 与 macOS 之间的差异</li><li data-v-50f125ac><strong data-v-50f125ac>渲染性能：</strong>参数化投影替代布料仿真</li></ul></div></div><div class="model-process-item" data-v-50f125ac><div class="model-item-header" data-v-50f125ac><h4 data-v-50f125ac>女性模型精细化处理</h4></div><div class="model-item-image mb-4" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>默认女模型 - 简化后</span></div></div><div class="model-item-content" data-v-50f125ac><ul class="list-disc pl-5 space-y-2 text-gray-700" data-v-50f125ac><li data-v-50f125ac><strong data-v-50f125ac>精细简化：</strong>保持女性体型特征的前提下进行拓扑优化</li><li data-v-50f125ac><strong data-v-50f125ac>服装适配：</strong>针对女性服装特点调整骨骼绑定</li><li data-v-50f125ac><strong data-v-50f125ac>质量平衡：</strong>在移动端性能与视觉效果间找到平衡</li><li data-v-50f125ac><strong data-v-50f125ac>细节保留：</strong>保留关键特征，确保试穿效果真实</li></ul></div></div><div class="model-process-item" data-v-50f125ac><div class="model-item-header" data-v-50f125ac><h4 data-v-50f125ac>女性模型材质系统</h4></div><div class="model-item-image mb-4" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>默认女模型材质节点 - 简化后</span></div></div><div class="model-item-content" data-v-50f125ac><ul class="list-disc pl-5 space-y-2 text-gray-700" data-v-50f125ac><li data-v-50f125ac><strong data-v-50f125ac>材质统一：</strong>与男性模型保持相同的材质节点结构</li><li data-v-50f125ac><strong data-v-50f125ac>皮肤质感：</strong>优化皮肤材质的次表面散射效果</li><li data-v-50f125ac><strong data-v-50f125ac>光照适配：</strong>调整材质参数适应不同光照环境</li><li data-v-50f125ac><strong data-v-50f125ac>服装兼容：</strong>确保与各类服装材质的良好融合</li></ul></div></div></div></div></div><div id="backend-api" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>后端系统与API设计</h3></div><div class="backend-content" data-v-50f125ac><div class="backend-main-content" data-v-50f125ac><div class="backend-description" data-v-50f125ac><p data-v-50f125ac> 后端系统基于Python Flask框架构建，采用RESTful API设计原则，提供完整的用户管理、 图像处理、虚拟试穿等服务。系统支持异步任务处理，通过任务队列管理耗时的AI推理操作， 确保前端用户体验的流畅性。部署在Ubuntu服务器上，具备良好的扩展性和稳定性。 </p><div class="backend-highlights" data-v-50f125ac><div class="backend-feature" data-v-50f125ac><div class="feature-icon" data-v-50f125ac>🔌</div><h5 data-v-50f125ac>RESTful API</h5><p data-v-50f125ac>标准化接口设计，支持多平台接入</p></div><div class="backend-feature" data-v-50f125ac><div class="feature-icon" data-v-50f125ac>⚡</div><h5 data-v-50f125ac>异步处理</h5><p data-v-50f125ac>Celery任务队列处理耗时操作</p></div><div class="backend-feature" data-v-50f125ac><div class="feature-icon" data-v-50f125ac>🔐</div><h5 data-v-50f125ac>安全认证</h5><p data-v-50f125ac>JWT Token身份验证机制</p></div><div class="backend-feature" data-v-50f125ac><div class="feature-icon" data-v-50f125ac>📊</div><h5 data-v-50f125ac>数据管理</h5><p data-v-50f125ac>SQLAlchemy ORM + Redis缓存</p></div></div></div><div class="api-implementations" data-v-50f125ac><div class="api-card" data-v-50f125ac><div class="api-header" data-v-50f125ac><h4 data-v-50f125ac>🌐 Flask API 服务实现</h4></div><div class="api-description" data-v-50f125ac><p data-v-50f125ac>基于Flask构建的REST API服务，提供图像上传、处理状态查询、结果获取等核心功能。支持跨域请求，集成了完整的错误处理和日志记录机制。</p></div><div class="code-showcase" data-v-50f125ac><div class="code-header" data-v-50f125ac><h5 data-v-50f125ac>API服务核心代码</h5><span class="code-language" data-v-50f125ac>Python</span></div><pre data-v-50f125ac><code class="language-python" data-v-50f125ac>${ssrInterpolate(apiCommunicationCode)}</code></pre></div><div class="api-endpoints" data-v-50f125ac><h5 data-v-50f125ac>主要API端点</h5><div class="endpoint-list" data-v-50f125ac><div class="endpoint-item" data-v-50f125ac><span class="http-method post" data-v-50f125ac>POST</span><span class="endpoint-path" data-v-50f125ac>/api/upload-image</span><span class="endpoint-desc" data-v-50f125ac>上传用户图像并启动虚拟试穿任务</span></div><div class="endpoint-item" data-v-50f125ac><span class="http-method get" data-v-50f125ac>GET</span><span class="endpoint-path" data-v-50f125ac>/api/task-status/{id}</span><span class="endpoint-desc" data-v-50f125ac>查询处理任务的状态和进度</span></div><div class="endpoint-item" data-v-50f125ac><span class="http-method get" data-v-50f125ac>GET</span><span class="endpoint-path" data-v-50f125ac>/api/health</span><span class="endpoint-desc" data-v-50f125ac>健康检查接口</span></div></div></div></div><div class="deployment-card" data-v-50f125ac><div class="deployment-header" data-v-50f125ac><h4 data-v-50f125ac>🚀 部署架构与运维</h4></div><div class="deployment-overview" data-v-50f125ac><div class="deploy-section" data-v-50f125ac><h5 data-v-50f125ac>服务器配置</h5><div class="config-grid" data-v-50f125ac><div class="config-item" data-v-50f125ac><strong data-v-50f125ac>操作系统:</strong> Ubuntu 20.04 LTS </div><div class="config-item" data-v-50f125ac><strong data-v-50f125ac>Python版本:</strong> Python 3.8+ </div><div class="config-item" data-v-50f125ac><strong data-v-50f125ac>Web服务器:</strong> Gunicorn + Nginx </div><div class="config-item" data-v-50f125ac><strong data-v-50f125ac>任务队列:</strong> Celery + Redis </div></div></div><div class="deploy-section" data-v-50f125ac><h5 data-v-50f125ac>技术特性</h5><div class="feature-grid" data-v-50f125ac><div class="tech-highlight" data-v-50f125ac><strong data-v-50f125ac>🔄 异步处理:</strong> 后台任务队列处理AI推理，避免阻塞请求 </div><div class="tech-highlight" data-v-50f125ac><strong data-v-50f125ac>💾 数据缓存:</strong> Redis缓存频繁访问的数据，提升响应速度 </div><div class="tech-highlight" data-v-50f125ac><strong data-v-50f125ac>📝 日志监控:</strong> 完整的请求日志和错误追踪机制 </div><div class="tech-highlight" data-v-50f125ac><strong data-v-50f125ac>🔒 安全防护:</strong> CORS跨域配置和请求限流保护 </div></div></div></div></div></div></div></div></div><div id="system-architecture" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>系统架构设计</h3></div><div class="work-content space-y-10" data-v-50f125ac><div class="info-card" data-v-50f125ac><div class="info-header text-center" data-v-50f125ac><h4 data-v-50f125ac>整体设计理念</h4></div><div class="info-content max-w-4xl mx-auto text-center" data-v-50f125ac><p class="text-lg leading-relaxed mb-6" data-v-50f125ac>前端采用 SwiftUI 构建，设备侧以 CoreML 完成本地推理与参数化渲染；后端部署于 Ubuntu，按&quot;用户/设计/渲染&quot;模块化拆分，提供鉴权、数据持久化与异步渲染任务管理。</p><div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8" data-v-50f125ac><div class="architecture-pillar" data-v-50f125ac><h5 class="pillar-title" data-v-50f125ac>移动端前端</h5><p class="pillar-desc" data-v-50f125ac>SwiftUI + CoreML<br data-v-50f125ac>本地推理与渲染</p></div><div class="architecture-pillar" data-v-50f125ac><h5 class="pillar-title" data-v-50f125ac>数据流转</h5><p class="pillar-desc" data-v-50f125ac>参数化设计数据<br data-v-50f125ac>HTTPS + JWT 安全传输</p></div><div class="architecture-pillar" data-v-50f125ac><h5 class="pillar-title" data-v-50f125ac>服务端后台</h5><p class="pillar-desc" data-v-50f125ac>Ubuntu 部署<br data-v-50f125ac>模块化微服务架构</p></div></div></div></div><div class="architecture-showcase" data-v-50f125ac><div class="info-header text-center mb-8" data-v-50f125ac><h4 data-v-50f125ac>系统架构全景图</h4></div><div class="architecture-image-container" data-v-50f125ac><div class="gallery-item max-w-5xl mx-auto" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: "/images/projects/yigui-app-2025/虚拟装配流水线示意图.png",
          alt: "虚拟装配流水线示意图",
          preset: "project",
        ...
        _push(`<span class="gallery-caption text-center" data-v-50f125ac>CoreML 算法流程图 - 从用户输入到参数化输出的完整智能分析流程</span></div></div></div><div class="parametric-showcase" data-v-50f125ac><div class="info-header text-center mb-8" data-v-50f125ac><h4 data-v-50f125ac>参数化表达系统</h4></div><div class="parametric-image-container" data-v-50f125ac><div class="gallery-item max-w-3xl mx-auto" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      if (selectedProject.value === "nus-sws-2024") {
        ...
        _push(`<div class="image-overlay" data-v-50f125ac><span class="overlay-text" data-v-50f125ac>点击查看大图</span></div></div></div></div><div id="team-info" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>团队信息</h3></div><div class="team-info-content" data-v-50f125ac><div class="team-info-grid" data-v-50f125ac><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>指导教授</h4></div><div class="info-content" data-v-50f125ac><p data-v-50f125ac>Bimlesh Wadhwa（Professor of NUS School of Computing）</p></div><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>TA/助教</h4></div><div class="info-content" data-v-50f125ac><p data-v-50f125ac>Melanie Khin Jing Hong (NUS)</p><p data-v-50f125ac>Charisma Kausar (NUS)</p></div></div><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>团队成员</h4></div><ul class="team-members-list" data-v-50f125ac><li data-v-50f125ac>我 <span class="leader-badge" data-v-50f125ac>队长</span> - 团队协调、注册登录模块、聊天功能</li><li data-v-50f125ac>Liang Zhuoran（UESTC） - 主页、好友动态功能制作</li><li data-v-50f125ac>YANG Jilin（UESTC） - 地图功能、导航功能</li><li data-v-50f125ac>LI Jingyan（NYU） - 海报制作</li><li data-v-50f125ac>JIN Hanze（UNNC） - 团队网页制作</li><li data-v-50f125ac>ZHAO Chengcheng（UESTC） - 市场调研与需求分析</li></ul></div></div></div></div><div id="team-work" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>团队作品：LiNkUS</h3></div><div class="work-content" data-v-50f125ac><div class="work-description" data-v-50f125ac><p data-v-50f125ac> LiNkUS是我们团队设计的校园社交应用原型，专为NUS学生打造的综合性社交平台。应用集成了实时地图聊天、好友动态分享、校园活动发布等核心功能，旨在增强校园内学生间的互动交流。 </p><p data-v-50f125ac> 应用采用现代化的UI设计语言，注重用户体验的流畅性和直观性。通过深入的用户研究和多轮迭代优化，我们打造了一个既实用又美观的社交产品原型。 </p><div class="prototype-links" data-v-50f125ac><a href="https://www.figma.com/proto/K79KSdRZ2iqkICTTFgVhOq/FINAL-FINAL-VERSION?node-id=31-4086&amp;p=f&amp;m=draw&amp;scaling=scale-down&amp;content-scaling=fixed&amp;page-id=0%3A1&amp;starting-point-node-id=31%3A4086&amp;show-proto-sidebar=1&amp;t=vBrl6Grze1tzWgMv-1" target="_blank" class="prototype-link" data-v-50f125ac> 查看Figma原型 </a><span class="access-note" data-v-50f125ac>（密码：90210）</span><a href="https://jinhz0531.wixsite.com/my-site-5" target="_blank" class="prototype-link" data-v-50f125ac> 查看宣传网站 </a></div></div><div class="work-gallery" data-v-50f125ac><div class="team-gallery-layout" data-v-50f125ac><div class="prototype-section" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>LiNkUS Figma原型设计</span></div></div><div class="screenshots-section" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>LiNkUS欢迎页面</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>LiNkUS校园地图功能</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>LiNkUS实时聊天功能</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>LiNkUS好友动态功能</span></div></div></div></div></div></div><div id="individual-work" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>个人作品：Individual Wrap</h3></div><div class="work-content" data-v-50f125ac><div class="work-description" data-v-50f125ac><p data-v-50f125ac> Individual Wrap是我参考Spotify年度总结风格设计的个人项目回顾网站。通过数据可视化的方式，生动地展示了我在SWS项目中的学习历程、时间投入、技能成长和项目亮点。 </p><p data-v-50f125ac> 设计中融入了现代化的渐变色彩、动态图表和个性化的布局设计，既体现了我对UI设计的理解，也完整记录了这次宝贵的学习经历。 </p><div class="prototype-links" data-v-50f125ac><a href="https://www.figma.com/proto/N6O73v3gWnRRq7EnM1ewIn/Individual-Wrap?node-id=29-2&amp;p=f&amp;t=Rrs3pCcDmYXxDGfK-1&amp;scaling=scale-down&amp;content-scaling=fixed&amp;page-id=0%3A1&amp;starting-point-node-id=18%3A20&amp;show-proto-sidebar=1" target="_blank" class="prototype-link" data-v-50f125ac> 查看个人作品原型 </a></div></div><div class="work-gallery" data-v-50f125ac><div class="individual-gallery-grid" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>Individual Wrap Figma原型图</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>Individual Wrap首页设计</span></div></div></div></div></div><div id="achievements" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目成果</h3></div><div class="achievements-content" data-v-50f125ac><div class="achievement-summary" data-v-50f125ac><div class="result-item" data-v-50f125ac><h4 data-v-50f125ac>团队荣誉</h4><p data-v-50f125ac>团队作品在10个小组中获得前三名</p><div class="award-image-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`</div>`);
        if (showNusCertificates.value) {
          _push(`<a href="/images/projects/nus-sws-2024/Top Project.png" target="_blank" download="NUS-SWS-2024-团队荣誉证书.png" class="download-button" data-v-50f125ac> 下载证书 </a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="result-item" data-v-50f125ac><h4 data-v-50f125ac>个人成绩</h4><p data-v-50f125ac>获得A+个人表现评价</p><div class="award-image-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`</div>`);
        if (showNusCertificates.value) {
          _push(`<a href="/images/projects/nus-sws-2024/个人A+.png" target="_blank" download="NUS-SWS-2024-个人成绩证书.png" class="download-button" data-v-50f125ac> 下载证书 </a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div></div></div><div id="project-summary" class="project-summary-section" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目总结</h3><div class="summary-content-wrapper" data-v-50f125ac><p class="summary-description" data-v-50f125ac> 这次NUS SOC SWS 2024项目给了我一次宝贵的国际化学习体验。 通过三周的密集学习，我不仅掌握了UI/UX设计的核心技能，更重要的是学会了如何在多元文化的团队中有效协作， 如何在压力下保持质量，以及如何将理论知识转化为实际的产品原型。 这段经历将成为我学术和职业发展路上的重要里程碑。 </p><div class="project-photos" data-v-50f125ac><div class="photo-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>项目期间个人照片</span></div><div class="photo-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>课堂学习环境</span></div></div></div></div><div class="back-to-overview-section" data-v-50f125ac><button class="back-overview-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg><span data-v-50f125ac>返回项目概览</span></button></div></section>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedProject.value === "mengsheng-2024") {
        _push(`<section class="project-detail" data-v-50f125ac><div class="back-button-container" data-v-50f125ac><button class="back-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg> 返回项目概览 </button></div><aside class="floating-nav" style="${ssrRenderStyle(selectedProject.value === "mengsheng-2024" ? null : { display: "none" })}" data-v-50f125ac><div class="floating-nav-content" data-v-50f125ac><div class="floating-nav-title" data-v-50f125ac>导航</div><nav class="floating-nav-items" data-v-50f125ac><a href="#team-info" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "team-info" }])}" data-v-50f125ac> 团队信息 </a><a href="#project-background" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "project-background" }])}" data-v-50f125ac> 项目背景 </a><a href="#project-overview" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "project-overview" }])}" data-v-50f125ac> 解决方案 </a><a href="#system-design" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "system-design" }])}" data-v-50f125ac> 系统设计 </a><a href="#software-algorithm" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "software-algorithm" }])}" data-v-50f125ac> 算法仿真 </a><a href="#hardware-implementation" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "hardware-implementation" }])}" data-v-50f125ac> 硬件实现 </a><a href="#testing-results" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "testing-results" }])}" data-v-50f125ac> 测试结果 </a><a href="#project-summary" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "project-summary" }])}" data-v-50f125ac> 项目总结 </a></nav></div></aside><div class="hero-section" data-v-50f125ac><div class="hero-content" data-v-50f125ac><div class="hero-text" data-v-50f125ac><span class="project-date" data-v-50f125ac>2024年9月</span><h1 class="hero-title" data-v-50f125ac>&quot;盟升杯&quot;电子设计竞赛</h1><h2 class="hero-subtitle" data-v-50f125ac>智能声源识别定位系统</h2><div class="hero-badges" data-v-50f125ac><span class="badge badge-accent" data-v-50f125ac>硬件系统开发</span><span class="badge badge-info" data-v-50f125ac>STM32编程</span><span class="badge badge-secondary" data-v-50f125ac>语音控制</span></div></div><div class="hero-image" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<div class="image-overlay" data-v-50f125ac><span class="overlay-text" data-v-50f125ac>点击查看大图</span></div></div></div></div><div id="team-info" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>团队信息</h3></div><div class="team-info-content" data-v-50f125ac><div class="team-info-grid" data-v-50f125ac><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>指导方</h4></div><div class="info-content" data-v-50f125ac><p data-v-50f125ac>电子科学与工程学院科协</p><p data-v-50f125ac>盟升电子公司专家</p></div></div><div class="info-card" data-v-50f125ac><div class="info-header" data-v-50f125ac><h4 data-v-50f125ac>团队成员</h4></div><ul class="team-members-list" data-v-50f125ac><li data-v-50f125ac>我 <span class="leader-badge" data-v-50f125ac>队长</span></li><li data-v-50f125ac>迪里亚尔江·阿司木江（计算机科学与工程学院）- 算法优化</li><li data-v-50f125ac>热法提·买买提热夏提（电子科学与工程学院） - 电路焊接与调试</li></ul></div></div></div></div><div id="project-background" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目背景与要求</h3></div><div class="background-content" data-v-50f125ac><div class="background-main-content" data-v-50f125ac><div class="background-description" data-v-50f125ac><p data-v-50f125ac> 本项目源于2024年盟升杯高年级组电子设计竞赛D题：&quot;智能声源识别定位系统&quot;。 竞赛要求设计并制作一个能够识别和定位声源的智能系统，在预设的测量区域内实现精确的声源定位与语音识别功能。 </p><div class="task-requirements" data-v-50f125ac><h4 data-v-50f125ac>具体任务要求</h4><ul class="requirements-list" data-v-50f125ac><li data-v-50f125ac><strong data-v-50f125ac>硬件约束：</strong>麦克风阵列形式可自行设计，但麦克风个数不能超过5个，整个声源定位系统的尺寸不能超过测量区域</li><li data-v-50f125ac><strong data-v-50f125ac>定位功能：</strong>系统能够在5个预设区域(A、B、C、D、E)内准确识别声源位置，定位误差不超过±5cm</li><li data-v-50f125ac><strong data-v-50f125ac>语音识别：</strong>系统设置为&quot;识别模式&quot;时，能够识别区分4条指令：&quot;打开灯光&quot;、&quot;关闭灯光&quot;、&quot;打开空调&quot;、&quot;关闭空调&quot;</li><li data-v-50f125ac><strong data-v-50f125ac>信号输入：</strong>指令通过手机、蓝牙音箱播放或自制播放设备输入</li><li data-v-50f125ac><strong data-v-50f125ac>结果显示：</strong>识别结果通过液晶屏幕在系统端进行实时显示</li></ul></div><div class="requirements-docs" data-v-50f125ac><h4 data-v-50f125ac>竞赛文档</h4><a href="/images/projects/mengsheng-2024/project-requirements.pdf" target="_blank" class="project-doc-button" data-v-50f125ac> 📄 查看完整题目要求 </a></div></div></div><div class="measurement-area-section" data-v-50f125ac><div class="area-diagram-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>系统整体架构图</span></div></div></div></div><div id="software-algorithm" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>算法设计与仿真</h3></div><div class="algorithm-content" data-v-50f125ac><div class="algorithm-description" data-v-50f125ac><p data-v-50f125ac> 在进行硬件实现之前，首先通过Python分析了不同语音指令的信号特征，然后通过MATLAB仿真验证了TDOA（时差定位）算法的可行性， 最后设计了ASR-PRO语音识别模块的控制逻辑。这一套完整的算法设计与仿真为硬件实现奠定了坚实的理论基础。 </p></div>`);
        _push(ssrRenderComponent(_component_CodeBlock, {
          title: "Python声音信号分析",
        ...
        _push(`<div class="python-analysis-results" data-v-50f125ac><h4 data-v-50f125ac>Python声音信号分析结果</h4><div class="analysis-description" data-v-50f125ac><p data-v-50f125ac> 通过Python的librosa库对&quot;打开灯光&quot;、&quot;关闭灯光&quot;、&quot;打开空调&quot;、&quot;关闭空调&quot;四条指令进行了完整的信号特征分析。 分析结果显示了不同指令在频域上的特征差异，为语音识别算法的参数调优和TDOA定位算法的设计提供了重要依据。 </p></div><div class="analysis-result-image" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>Python声音信号分析结果 - 四条指令的频域特征对比</span></div></div></div>`);
        _push(ssrRenderComponent(_component_CodeBlock, {
          title: "TDOA声源定位算法仿真",
        ...
        _push(`<div class="simulation-results" data-v-50f125ac><h4 data-v-50f125ac>MATLAB仿真验证结果</h4><div class="simulation-description" data-v-50f125ac><p data-v-50f125ac> 通过MATLAB进行了大量的仿真验证，测试了不同声源位置下的定位精度。 仿真结果表明，TDOA算法在理想条件下能够实现±2cm的定位精度， 完全满足竞赛要求的±5cm指标。 </p></div><div class="simulation-gallery" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>仿真结果1 - 区域A声源定位验证</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>仿真结果2 - 区域E声源定位验证</span></div></div><div class="simulation-analysis" data-v-50f125ac><h5 data-v-50f125ac>仿真分析总结</h5><ul data-v-50f125ac><li data-v-50f125ac>在5个预设区域内进行了100次随机声源定位测试</li><li data-v-50f125ac>平均定位误差：1.8cm，最大误差：3.2cm</li><li data-v-50f125ac>算法收敛时间：平均15ms，满足实时性要求</li><li data-v-50f125ac>在噪声环境下（SNR&gt;20dB）仍能保持较高精度</li></ul></div></div>`);
        _push(ssrRenderComponent(_component_CodeBlock, {
          title: "ASR-PRO语音识别控制",
        ...
        _push(`<div class="asr-code-diagram" data-v-50f125ac><h4 data-v-50f125ac>ASR-PRO代码架构图</h4><div class="code-diagram-description" data-v-50f125ac><p data-v-50f125ac> ASR-PRO语音识别模块采用状态机设计模式，通过硬件中断处理语音识别结果， 实现了高效的语音命令解析和设备控制逻辑。 </p></div><div class="diagram-image" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>ASR-PRO语音识别控制流程图</span></div></div></div></div></div><div id="hardware-implementation" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>硬件设计与实现</h3></div><div class="hardware-content" data-v-50f125ac><div class="hardware-description" data-v-50f125ac><p data-v-50f125ac> 硬件系统以STM32H750为核心，集成了高精度ADC、麦克风阵列、语音识别模块等关键组件。 电路设计充分考虑了信号完整性和噪声抑制，确保声音信号的高质量采集。 </p><p data-v-50f125ac> 系统采用四麦克风矩形阵列布局，通过精确的时间同步和信号处理， 实现对声源位置的高精度定位。各硬件模块经过严格的电磁兼容性设计， 确保在复杂电磁环境下的稳定工作。 </p></div><div class="hardware-section" data-v-50f125ac><h4 data-v-50f125ac>核心处理器模块</h4><div class="hardware-layout left-image" data-v-50f125ac><div class="hardware-image-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>STM32H750核心板 - 400MHz Cortex-M7</span></div></div><div class="hardware-specs" data-v-50f125ac><ul data-v-50f125ac><li data-v-50f125ac>STM32H750VBT6 微控制器，主频400MHz</li><li data-v-50f125ac>Cortex-M7内核，支持浮点运算单元</li><li data-v-50f125ac>128KB Flash + 1MB RAM</li><li data-v-50f125ac>丰富的外设接口：SPI、I2C、UART、ADC等</li></ul></div></div></div><div class="hardware-section" data-v-50f125ac><h4 data-v-50f125ac>声音采集与处理模块</h4><div class="hardware-layout right-image" data-v-50f125ac><div class="hardware-specs" data-v-50f125ac><ul data-v-50f125ac><li data-v-50f125ac>支持离线语音识别，响应时间&lt;100ms</li><li data-v-50f125ac>内置降噪算法，适应复杂声学环境</li><li data-v-50f125ac>可自定义命令词，支持中文识别</li><li data-v-50f125ac>集成麦克风阵列接口</li></ul></div><div class="hardware-image-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>ASR-PRO语音识别模块</span></div></div></div></div><div class="hardware-section" data-v-50f125ac><h4 data-v-50f125ac>数模转换器模块</h4><div class="hardware-layout left-image" data-v-50f125ac><div class="hardware-image-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>AD7606高精度ADC模块</span></div></div><div class="hardware-specs" data-v-50f125ac><ul data-v-50f125ac><li data-v-50f125ac>16位分辨率，8通道同步采样ADC</li><li data-v-50f125ac>最高采样率200kSPS，满足声音信号处理需求</li><li data-v-50f125ac>内置可编程增益放大器，增益范围1-10倍</li><li data-v-50f125ac>差分输入设计，有效抑制共模噪声</li><li data-v-50f125ac>SPI/并行接口，便于与STM32连接</li></ul></div></div></div><div class="hardware-section" data-v-50f125ac><h4 data-v-50f125ac>麦克风阵列系统</h4><div class="mic-array-layout" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>四麦克风矩形阵列接线图</span></div></div><div class="mic-array-description" data-v-50f125ac><p data-v-50f125ac> 采用四麦克风矩形阵列布局，阵列尺寸为40cm×20cm。 通过精确的几何布局和时间同步，实现高精度的TDOA计算。 每个麦克风均经过精确的相位校准，确保信号采集的一致性。 </p><div class="array-specs" data-v-50f125ac><div class="spec-item" data-v-50f125ac><strong data-v-50f125ac>阵列尺寸：</strong>40cm × 20cm </div><div class="spec-item" data-v-50f125ac><strong data-v-50f125ac>麦克风数量：</strong>4个 (矩形布局) </div><div class="spec-item" data-v-50f125ac><strong data-v-50f125ac>采样率：</strong>20kHz </div><div class="spec-item" data-v-50f125ac><strong data-v-50f125ac>定位精度：</strong>±2cm </div></div></div></div><div class="hardware-section" data-v-50f125ac><h4 data-v-50f125ac>外框的3D建模与打印</h4><div class="modeling-description" data-v-50f125ac><p data-v-50f125ac> 为了保护电路板和提供美观的外观，我们使用SOLIDWORKS进行了外框架的3D建模设计。 设计考虑了麦克风阵列的布局、电路板固定、散热通风以及用户操作的便利性。 完成建模后，我们在校园内使用免费的3D打印服务制作了外框架。 </p></div><div class="modeling-video-section" data-v-50f125ac><div class="video-item" data-v-50f125ac><video controls="controls" preload="metadata" class="video-player"${ssrRenderAttr("poster", _imports_2)} data-v-50f125ac><source${ssrRenderAttr("src", _imports_3)} type="video/mp4" data-v-50f125ac><p data-v-50f125ac>您的浏览器不支持视频播放。<a href="/images/projects/mengsheng-2024/外框架3D建模展示.mp4" target="_blank" style="${ssrRenderStyle({ "color": "#ff6b35" })}" data-v-50f125ac>点击下载视频</a></p></video><div class="video-caption" data-v-50f125ac>外框架3D建模展示 - SOLIDWORKS</div></div></div></div><div class="hardware-section" data-v-50f125ac><h4 data-v-50f125ac>完整系统实物</h4><div class="system-gallery" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>完整系统实物图 - 正面视角</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>完整系统实物图 - 俯视视角</span></div></div><div class="system-description" data-v-50f125ac><p data-v-50f125ac> 系统集成度高，结构紧凑。核心处理板、语音识别模块、麦克风阵列等 各组件通过精心设计的PCB布局实现最优的信号传输和电磁兼容性。 整机经过严格的环境测试，确保在不同温湿度条件下的稳定运行。 </p></div></div></div></div><div id="testing-results" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>系统测试与结果</h3></div><div class="testing-content" data-v-50f125ac><div class="testing-description" data-v-50f125ac><p data-v-50f125ac> 系统经过了严格的功能测试和性能验证，最终在盟升电子公司现场进行了正式测试并通过验收。 定位精度、响应时间、语音识别准确率等关键指标均符合竞赛标准。 由于现场规定禁止拍照摄影，因此无法提供正式演示视频，但保留了调试过程中的测试录像。 </p></div><div class="debug-videos-section" data-v-50f125ac><h4 data-v-50f125ac>系统调试演示视频</h4><div class="videos-description" data-v-50f125ac><p data-v-50f125ac> 以下是系统开发调试过程中录制的演示视频，展示了声源定位和语音识别功能的实际运行效果。 </p></div><div class="videos-gallery" data-v-50f125ac><div class="video-item" data-v-50f125ac><video controls="controls" preload="metadata" class="video-player"${ssrRenderAttr("poster", _imports_2)} data-v-50f125ac><source${ssrRenderAttr("src", _imports_4)} type="video/mp4" data-v-50f125ac><p data-v-50f125ac>您的浏览器不支持视频播放。<a href="/images/projects/mengsheng-2024/debug-video-1.mp4" target="_blank" style="${ssrRenderStyle({ "color": "#ff6b35" })}" data-v-50f125ac>点击下载视频</a></p></video><div class="video-caption" data-v-50f125ac>调试视频1 - 数模转换器AD7606调试 (22MB)</div></div><div class="video-item" data-v-50f125ac><video controls="controls" preload="metadata" class="video-player"${ssrRenderAttr("poster", _imports_2)} data-v-50f125ac><source${ssrRenderAttr("src", _imports_5)} type="video/mp4" data-v-50f125ac><p data-v-50f125ac>您的浏览器不支持视频播放。<a href="/images/projects/mengsheng-2024/debug-video-2.mp4" target="_blank" style="${ssrRenderStyle({ "color": "#ff6b35" })}" data-v-50f125ac>点击下载视频</a></p></video><div class="video-caption" data-v-50f125ac>调试视频2 - 语音识别功能演示 (74MB)</div></div></div></div><div class="competition-results" data-v-50f125ac><div class="result-center" data-v-50f125ac><h4 data-v-50f125ac>竞赛成绩</h4><p data-v-50f125ac>三等奖（奖金2,000RMB）</p><div class="award-image-container" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`</div>`);
        if (showMengshengCertificates.value) {
          _push(`<a href="/images/projects/mengsheng-2024/award-certificate.pdf" target="_blank" download="盟升杯三等奖证书.pdf" class="download-button" data-v-50f125ac> 下载证书 </a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div></div></div><div id="project-summary" class="project-summary-section" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目总结</h3><div class="summary-content-wrapper" data-v-50f125ac><p class="summary-description" data-v-50f125ac> 这是我们团队首次涉足具有相当工程量的嵌入式项目。从零开始，我们投入了大量时间学习和实践。 最大的挑战在于软件层面，特别是如何将 AD7606 采集到的多通道实时数据，无缝地送入 TDOA 定位算法中进行处理。 尽管我们成功驱动了所有硬件模块，并实现了稳定的语音识别功能，但由于在 ADC、DMA 的中断处理及不同代码库融合上的经验不足，最终未能完成定位功能的联调。 一个多月的全力投入，无数个深夜的调试与探索，是一段充满挑战又收获满满的旅程。 我们没有因为困难而放弃，而是将所有精力倾注于此，在有限的时间里边学边做，体验了从理论到实践的完整过程。 虽然最终系统未能实现全部功能，但我们搭建了完整的硬件系统，攻克了大部分软件难题，更重要的是，收获了宝贵的团队协作经验和解决复杂工程问题的能力。 我们为已完成的部分感到自豪，也为留下的遗憾感到激励。 </p><div class="project-photos" data-v-50f125ac><div class="photo-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>颁奖典礼现场</span></div><div class="photo-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>队友在焊接AD7606</span></div></div></div></div><div class="back-to-overview-section" data-v-50f125ac><button class="back-overview-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg><span data-v-50f125ac>返回项目概览</span></button></div></section>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedProject.value === "led-voice-2025") {
        _push(`<section class="project-detail" data-v-50f125ac><div class="back-button-container" data-v-50f125ac><button class="back-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg> 返回项目概览 </button></div><aside class="floating-nav" style="${ssrRenderStyle(selectedProject.value === "led-voice-2025" ? null : { display: "none" })}" data-v-50f125ac><div class="floating-nav-content" data-v-50f125ac><div class="floating-nav-title" data-v-50f125ac>导航</div><nav class="floating-nav-items" data-v-50f125ac><a href="#course-info" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "course-info" }])}" data-v-50f125ac> 课设要求 </a><a href="#project-intro" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "project-intro" }])}" data-v-50f125ac> 项目介绍 </a><a href="#hardware-design" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "hardware-design" }])}" data-v-50f125ac> 硬件设计 </a><a href="#led-software-design" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "led-software-design" }])}" data-v-50f125ac> 软件设计 </a><a href="#led-function-demo" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "led-function-demo" }])}" data-v-50f125ac> 功能演示 </a><a href="#led-extended-thinking" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "led-extended-thinking" }])}" data-v-50f125ac> 拓展思考 </a><a href="#led-achievements" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "led-achievements" }])}" data-v-50f125ac> 项目总结 </a></nav></div></aside><div class="hero-section" data-v-50f125ac><div class="hero-content" data-v-50f125ac><div class="hero-text" data-v-50f125ac><span class="project-date" data-v-50f125ac>2025年1月-2025年2月</span><h1 class="hero-title" data-v-50f125ac>LED语音交互灯板</h1><h2 class="hero-subtitle" data-v-50f125ac>智能照明系统设计与实现 - 课程设计</h2><div class="hero-badges" data-v-50f125ac><span class="badge badge-accent" data-v-50f125ac>硬件系统开发</span><span class="badge badge-info" data-v-50f125ac>Arduino编程</span><span class="badge badge-secondary" data-v-50f125ac>语音交互</span></div></div><div class="hero-image" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>系统硬件连接图 - 展示各模块间的连接关系</span></div></div></div><div class="hardware-modules" data-v-50f125ac><h4 data-v-50f125ac>核心硬件模块</h4><div class="modules-gallery" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>Arduino UNO - 系统主控制器</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>ASR-PRO - 语音识别核心模块</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>WS2812 LED - 可编程RGB显示单元</span></div></div><div class="hardware-specs" data-v-50f125ac><div class="spec-grid" data-v-50f125ac><div class="spec-card" data-v-50f125ac><h5 data-v-50f125ac>Arduino UNO</h5><ul data-v-50f125ac><li data-v-50f125ac>低价格的微控制器</li><li data-v-50f125ac>14个数字I/O引脚</li><li data-v-50f125ac>16MHz 时钟频率</li><li data-v-50f125ac>串口通信支持</li></ul></div><div class="spec-card" data-v-50f125ac><h5 data-v-50f125ac>ASR-PRO模块</h5><ul data-v-50f125ac><li data-v-50f125ac>支持最多50个命令词</li><li data-v-50f125ac>中文语音识别</li><li data-v-50f125ac>语音合成功能</li><li data-v-50f125ac>3-5米识别距离</li></ul></div><div class="spec-card" data-v-50f125ac><h5 data-v-50f125ac>WS2812 LED</h5><ul data-v-50f125ac><li data-v-50f125ac>64个LED像素点（8×8）</li><li data-v-50f125ac>RGB全彩显示</li><li data-v-50f125ac>单总线控制</li><li data-v-50f125ac>独立像素控制</li></ul></div></div></div></div><div class="final-product" data-v-50f125ac><h4 data-v-50f125ac>系统成品展示</h4><div class="product-layout" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>LED智能语音灯板成品 - 完整系统展示</span></div></div></div></div></div><div id="led-software-design" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>软件设计</h3></div><div class="led-software-content" data-v-50f125ac><div class="led-code-section" data-v-50f125ac><h4 data-v-50f125ac>Arduino UNO 主控程序</h4><p data-v-50f125ac>负责LED灯效控制和串口通信处理：</p>`);
        _push(ssrRenderComponent(_component_CodeBlock, {
          code: arduinoCode,
          language: "cpp",
        ...
        _push(`</div><div class="led-code-section" data-v-50f125ac><h4 data-v-50f125ac>ASR-PRO 语音识别程序</h4><p data-v-50f125ac>处理语音识别和命令发送：</p>`);
        _push(ssrRenderComponent(_component_CodeBlock, {
          code: asrproCode,
          language: "cpp",
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>语音信号语谱图 - 我研究的语音特征提取基础</span></div><div class="spectrogram-explanation" data-v-50f125ac><p data-v-50f125ac> 我在学习过程中发现，通过傅里叶变换可以将简单的声音波形转化为信息丰富的语谱图。 这让我意识到，语音中蕴含的信息远比我之前想象的丰富。除了基本的命令词， 我还可以从中提取音高变化、能量分布、共振峰等特征，这些都可能反映说话者的情绪状态。 </p></div></div></div><div class="future-applications" data-v-50f125ac><h5 data-v-50f125ac>我设想的应用场景</h5><div class="application-grid" data-v-50f125ac><div class="application-item" data-v-50f125ac><h6 data-v-50f125ac>个性化交互</h6><p data-v-50f125ac>我希望系统能识别不同用户的声音特征，甚至包括方言口音，让每个人都能获得个性化的交互体验。</p></div><div class="application-item" data-v-50f125ac><h6 data-v-50f125ac>情感感知</h6><p data-v-50f125ac> 我最感兴趣的是让灯光能够感知情绪。比如当我疲惫时说&quot;关灯&quot;， 系统能从我的语调中察觉到疲惫，自动调整为柔和的暖光而不是直接关闭。 这样的交互会更有温度。 </p></div></div></div></div></div><div class="evolution-part" data-v-50f125ac><div class="part-header" data-v-50f125ac><div class="part-number" data-v-50f125ac>02</div><h4 data-v-50f125ac>架构的革新：从云端到边缘</h4><p class="part-subtitle" data-v-50f125ac>让AI在小小的芯片上也能思考</p></div><div class="evolution-content" data-v-50f125ac><div class="challenge-section" data-v-50f125ac><h5 data-v-50f125ac>我面临的技术选择：云端还是本地？</h5><div class="comparison-table" data-v-50f125ac><div class="comparison-item cloud" data-v-50f125ac><h6 data-v-50f125ac>云端处理</h6><div class="pros-cons" data-v-50f125ac><div class="pros" data-v-50f125ac><strong data-v-50f125ac>优势：</strong>计算能力强大、模型更新便捷 </div><div class="cons" data-v-50f125ac><strong data-v-50f125ac>劣势：</strong>网络延迟、隐私担忧、依赖网络 </div></div></div><div class="comparison-item edge" data-v-50f125ac><h6 data-v-50f125ac>本地处理</h6><div class="pros-cons" data-v-50f125ac><div class="pros" data-v-50f125ac><strong data-v-50f125ac>优势：</strong>响应迅速、隐私安全、离线工作 </div><div class="cons" data-v-50f125ac><strong data-v-50f125ac>劣势：</strong>硬件限制、模型简化 </div></div></div></div><p class="conclusion" data-v-50f125ac> 经过思考，我认为对于智能家居这种需要即时响应且涉及隐私的场景，本地处理是更合适的选择。 </p></div><div class="solution-section" data-v-50f125ac><h5 data-v-50f125ac>我找到的解决方案：TinyML技术</h5><div class="tinyml-showcase" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>我研究的TinyML实现流程</span></div><div class="tinyml-steps" data-v-50f125ac><div class="step-item" data-v-50f125ac><div class="step-number" data-v-50f125ac>1</div><div class="step-content" data-v-50f125ac><h6 data-v-50f125ac>云端训练</h6><p data-v-50f125ac>先在电脑上训练复杂的AI模型</p></div></div><div class="step-item" data-v-50f125ac><div class="step-number" data-v-50f125ac>2</div><div class="step-content" data-v-50f125ac><h6 data-v-50f125ac>模型优化</h6><p data-v-50f125ac>通过量化等技术压缩模型大小</p></div></div><div class="step-item" data-v-50f125ac><div class="step-number" data-v-50f125ac>3</div><div class="step-content" data-v-50f125ac><h6 data-v-50f125ac>嵌入式部署</h6><p data-v-50f125ac>将优化后的模型部署到Arduino等硬件</p></div></div></div></div><p class="metaphor" data-v-50f125ac> 我迫不及待想要把更多的灯板接入联网的AI模型，让小小的灯板也能具备智能分析能力。 </p></div></div></div><div class="evolution-part" data-v-50f125ac><div class="part-header" data-v-50f125ac><div class="part-number" data-v-50f125ac>03</div><h4 data-v-50f125ac>体验的升华：从工具到艺术</h4><p class="part-subtitle" data-v-50f125ac>让每一束光都有温度和个性</p></div><div class="evolution-content" data-v-50f125ac><div class="experience-detail" data-v-50f125ac><h5 data-v-50f125ac>我对用户体验的思考</h5><p data-v-50f125ac> 我发现当前的LED控制还比较生硬。我希望未来能通过Gamma校正等技术， 让每一次光的变化都更贴近人眼的感知特性，让光的淡入淡出如呼吸般自然。 </p></div><div class="generative-art" data-v-50f125ac><h5 data-v-50f125ac>我的终极构想：生成式灯光艺术</h5><div class="art-concept" data-v-50f125ac><div class="art-layout" data-v-50f125ac><div class="art-description" data-v-50f125ac><p data-v-50f125ac><strong data-v-50f125ac>我设想的进化路径：</strong></p><p data-v-50f125ac> 未来的灯光模式不应該是固定的几种预设，而是能够根据我的情绪、声音的节奏， 甚至周围环境的音乐来实时生成独特的光效。我找到了叫做Mozilla Common Voice的网站可以提供大量中文方言的语音数据， 后续可以通过利用数据训练AI模型， 让灯板可以听懂全国各地的方言并实现灯光的个性化。 </p></div><div class="dataset-showcase" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>Mozilla Common Voice - 我关注的语音数据集平台</span></div></div></div></div></div><div class="final-vision" data-v-50f125ac><h5 data-v-50f125ac>我的愿景</h5><p class="vision-text" data-v-50f125ac> 我希望有一天，这块灯板不再只是一个照明工具，而是能够理解我的情绪、 与我产生共鸣的智能伙伴。从简单的&quot;语音开关&quot;，真正进化为有温度的&quot;感知伙伴&quot;。 </p></div></div></div></div></div><div id="led-achievements" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目总结</h3></div><div class="led-achievements-content" data-v-50f125ac><div class="achievements-showcase" data-v-50f125ac><div class="achievement-description" data-v-50f125ac><p data-v-50f125ac> 本次课程设计完成了智能语音交互LED灯板系统的设计与实现，涵盖了硬件搭建、 软件编程、系统集成等多个环节。通过这个项目，深入学习了嵌入式开发和语音识别技术， 并获得了较好的课程成绩。 </p></div><div class="course-result" data-v-50f125ac><div class="result-item" data-v-50f125ac><span class="result-label" data-v-50f125ac>完成时间</span><span class="result-value" data-v-50f125ac>2025年1月-2025年2月</span></div><div class="result-item" data-v-50f125ac><span class="result-label" data-v-50f125ac>完成质量</span><span class="result-value" data-v-50f125ac>系统功能完整</span></div><div class="result-item" data-v-50f125ac><span class="result-label" data-v-50f125ac>技术深度</span><span class="result-value" data-v-50f125ac>涵盖多个技术领域</span></div></div><div class="grade-certificate" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>课程成绩截图</span></div></div></div><div class="project-insights" data-v-50f125ac><div class="insights-section" data-v-50f125ac><h4 data-v-50f125ac>我的启发：超越功能，这个项目教会我的三件事</h4><div class="insights-grid" data-v-50f125ac><div class="insight-card" data-v-50f125ac><div class="insight-number" data-v-50f125ac>1</div><div class="insight-content" data-v-50f125ac><h6 data-v-50f125ac>智能的本质是&quot;感知&quot;，而非&quot;执行&quot;</h6><p data-v-50f125ac> 真正的智能交互，在于理解声音背后的情感与个性，而不只是被动地解码命令。 它应该从一个&quot;工具&quot;进化为一个&quot;伙伴&quot;。 </p></div></div><div class="insight-card" data-v-50f125ac><div class="insight-number" data-v-50f125ac>2</div><div class="insight-content" data-v-50f125ac><h6 data-v-50f125ac>好产品的诞生需&quot;工业级&quot;的思考</h6><p data-v-50f125ac> 从一个有趣的原型到一个可靠的产品，必须跨越从&quot;作坊式&quot;开发到&quot;工业级&quot;设计的鸿沟， 系统性地思考边缘计算、模型优化等真实世界的工程挑战。 </p></div></div><div class="insight-card" data-v-50f125ac><div class="insight-number" data-v-50f125ac>3</div><div class="insight-content" data-v-50f125ac><h6 data-v-50f125ac>好体验的源头是对&quot;人&quot;的尊重</h6><p data-v-50f125ac> 技术的终点是服务于人的感受。无论是遵循人眼规律的平滑光效，还是创造惊喜的生成式艺术， 最动人的设计，永远根植于对物理和生理规律的深刻理解与尊重。 </p></div></div></div></div><div class="gratitude" data-v-50f125ac><p data-v-50f125ac>感谢晓海波教授的悉心指导，这次课程设计让我受益匪浅。</p></div></div></div></div><div class="back-to-overview-section" data-v-50f125ac><button class="back-overview-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg><span data-v-50f125ac>返回项目概览</span></button></div></section>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedProject.value === "restaurant-system-2025") {
        _push(`<section class="project-detail" data-v-50f125ac><div class="back-button-container" data-v-50f125ac><button class="back-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg> 返回项目概览 </button></div><aside class="floating-nav" style="${ssrRenderStyle(selectedProject.value === "restaurant-system-2025" ? null : { display: "none" })}" data-v-50f125ac><div class="floating-nav-content" data-v-50f125ac><div class="floating-nav-title" data-v-50f125ac>导航</div><nav class="floating-nav-items" data-v-50f125ac><a href="#restaurant-info" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "restaurant-info" }])}" data-v-50f125ac> 项目概述 </a><a href="#restaurant-architecture" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "restaurant-architecture" }])}" data-v-50f125ac> 技术架构 </a><a href="#restaurant-features" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "restaurant-features" }])}" data-v-50f125ac> 功能展示 </a><a href="#restaurant-demo" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "restaurant-demo" }])}" data-v-50f125ac> 系统演示 </a><a href="#restaurant-achievements" class="${ssrRenderClass(["floating-nav-card", { active: currentSection.value === "restaurant-achievements" }])}" data-v-50f125ac> 项目总结 </a></nav></div></aside><div class="hero-section" data-v-50f125ac><div class="hero-content" data-v-50f125ac><div class="hero-text" data-v-50f125ac><span class="project-date" data-v-50f125ac>2025年6月</span><h1 class="hero-title" data-v-50f125ac>美莲花餐厅支出管理系统</h1><h2 class="hero-subtitle" data-v-50f125ac>نىلۇپار ئاشخانا چىقىم خاتىرىسى سىستېمىسى</h2><div class="hero-badges" data-v-50f125ac><span class="badge badge-primary" data-v-50f125ac>PyQt6</span><span class="badge badge-info" data-v-50f125ac>SQLite数据库</span><span class="badge badge-success" data-v-50f125ac>Deepseek API</span></div></div><div class="hero-image" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>用户登录界面</span></div></div></div><div class="feature-showcase reverse" data-v-50f125ac><div class="feature-images" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>支出录入界面</span></div></div><div class="feature-description" data-v-50f125ac><h4 data-v-50f125ac>支出录入管理</h4><p data-v-50f125ac> 主界面提供直观的支出录入功能，支持按分类快速录入支出数据。 界面采用卡片式布局，分类按钮网格化显示，支持自定义分类管理。 每次录入都有二次确认对话框，确保数据准确性。 </p><div class="feature-specs" data-v-50f125ac><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>录入方式</span><span class="spec-value" data-v-50f125ac>分类按钮快速录入</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>数据验证</span><span class="spec-value" data-v-50f125ac>金额格式验证</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>用户体验</span><span class="spec-value" data-v-50f125ac>二次确认机制</span></div></div></div></div><div class="feature-showcase" data-v-50f125ac><div class="feature-description" data-v-50f125ac><h4 data-v-50f125ac>每日记录管理</h4><p data-v-50f125ac> 系统提供当日支出记录的查看和管理功能，支持记录的编辑和删除操作。 界面以表格形式展示当日所有支出记录，包含时间、分类、金额、备注等详细信息。 </p><div class="feature-specs" data-v-50f125ac><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>显示方式</span><span class="spec-value" data-v-50f125ac>表格化展示</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>操作功能</span><span class="spec-value" data-v-50f125ac>编辑/删除记录</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>数据完整性</span><span class="spec-value" data-v-50f125ac>详细信息展示</span></div></div></div><div class="feature-images" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>每日记录管理界面</span></div></div></div><div class="feature-showcase reverse" data-v-50f125ac><div class="feature-images" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>单时段分析界面</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>数据可视化饼图</span></div></div></div><div class="feature-showcase-vertical" data-v-50f125ac><div class="feature-description-center" data-v-50f125ac><h4 data-v-50f125ac>AI智能分析</h4><p data-v-50f125ac> 系统集成DeepSeek AI，提供专业的餐厅财务分析服务。 双时段对比分析时，AI会自动生成深度分析报告，包含支出趋势分析、异常识别和经营建议。 分析结果以Markdown格式美观展示，支持导出保存。 出于安全考虑，AI分析功能仅限管理员使用，普通用户无法访问此功能。 </p><div class="feature-specs-horizontal" data-v-50f125ac><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>AI引擎</span><span class="spec-value" data-v-50f125ac>DeepSeek API</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>分析深度</span><span class="spec-value" data-v-50f125ac>趋势+异常+建议</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>展示格式</span><span class="spec-value" data-v-50f125ac>Markdown富文本</span></div></div></div><div class="feature-images-dual" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>AI分析界面</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>AI分析结果展示</span></div></div></div><div class="feature-showcase-vertical" data-v-50f125ac><div class="feature-description-center" data-v-50f125ac><h4 data-v-50f125ac>系统设置管理</h4><p data-v-50f125ac> 系统提供完善的设置管理功能，包括用户管理和分类管理。 支持用户密码修改、角色管理，以及支出分类的增删改操作，满足个性化需求。 </p><div class="feature-specs-horizontal" data-v-50f125ac><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>用户管理</span><span class="spec-value" data-v-50f125ac>密码修改/角色管理</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>分类管理</span><span class="spec-value" data-v-50f125ac>增删改分类</span></div><div class="spec-item" data-v-50f125ac><span class="spec-label" data-v-50f125ac>双语支持</span><span class="spec-value" data-v-50f125ac>中文/维语分类名</span></div></div></div><div class="feature-images-dual" data-v-50f125ac><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>用户管理界面</span></div><div class="gallery-item" data-v-50f125ac>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<span class="gallery-caption" data-v-50f125ac>分类管理界面</span></div></div></div></div></div><div id="restaurant-demo" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>系统完整演示</h3></div><div class="restaurant-demo-content" data-v-50f125ac><div class="demo-intro" data-v-50f125ac><p data-v-50f125ac></p></div><div class="led-demo-video-section" data-v-50f125ac><h4 data-v-50f125ac>系统完整流程演示</h4><div class="video-item" data-v-50f125ac><video controls="controls" preload="metadata" class="video-player"${ssrRenderAttr("poster", _imports_8)} data-v-50f125ac><source${ssrRenderAttr("src", _imports_9)} type="video/mp4" data-v-50f125ac><p data-v-50f125ac>您的浏览器不支持视频播放。<a href="/images/projects/restaurant-system-2025/restaurant-system-demo.mp4" target="_blank" style="${ssrRenderStyle({ "color": "#ff6b35" })}" data-v-50f125ac>点击下载视频</a></p></video><div class="video-caption" data-v-50f125ac>展示了登录、支出录入、数据查询、报表分析、AI智能分析等核心功能的完整操作流程 (15MB)</div></div></div></div></div><div id="restaurant-achievements" class="section" data-v-50f125ac><div class="section-header" data-v-50f125ac><h3 class="section-title" data-v-50f125ac>项目总结与收获</h3></div><div class="restaurant-achievements-content" data-v-50f125ac><div class="project-stats" data-v-50f125ac><div class="stats-grid" data-v-50f125ac><div class="stat-item" data-v-50f125ac><div class="stat-number" data-v-50f125ac>100%</div><div class="stat-label" data-v-50f125ac>功能完成度</div></div><div class="stat-item" data-v-50f125ac><div class="stat-number" data-v-50f125ac>2</div><div class="stat-label" data-v-50f125ac>双语言支持</div></div><div class="stat-item" data-v-50f125ac><div class="stat-number" data-v-50f125ac>12+</div><div class="stat-label" data-v-50f125ac>核心模块</div></div><div class="stat-item" data-v-50f125ac><div class="stat-number" data-v-50f125ac>AI</div><div class="stat-label" data-v-50f125ac>智能分析</div></div></div></div><div class="achievements-overview" data-v-50f125ac><div class="achievement-section" data-v-50f125ac><h4 data-v-50f125ac>核心成果</h4><p class="achievement-summary" data-v-50f125ac> 经过一个多月的实际使用，这套系统真正解决了我们餐厅的实际问题。收银员从以前的手写记录到现在的一键录入，工作效率大幅提升。 我爸也不用再花大量时间去整理Excel表格，系统自动生成的报表和AI分析让他能够更直观地了解餐厅的经营状况，做出更好的经营决策。 </p></div><div class="learning-insights" data-v-50f125ac><h4 data-v-50f125ac>项目启发</h4><div class="insights-content" data-v-50f125ac><p data-v-50f125ac> 看到收银员从一开始不会用电脑，到现在熟练使用我的系统，看到我爸不用再熬夜整理账目， 这种成就感是任何课堂项目都给不了的。技术的价值在于解决真实世界的问题。 </p><p data-v-50f125ac> 双语界面不是为了炫技，而是因为我们这里有维族员工。大按钮不是为了美观，而是因为收银员经常戴手套操作。 真正的用户体验设计要从用户的实际需求出发。 </p><p data-v-50f125ac> AI分析不是为了显摆技术，而是真正帮助我爸分析经营数据，发现哪些支出异常，哪个月份需要注意成本控制。 技术要服务于实际业务需求，而不是为了技术而技术。 </p></div></div><div class="future-plans" data-v-50f125ac><h4 data-v-50f125ac>未来规划</h4><p data-v-50f125ac> 这个系统还有很多可以改进的地方。我计划增加库存管理功能， 帮助餐厅更好地控制食材成本；还想加入销售数据分析， 让支出和收入数据结合起来，给我爸提供更全面的经营建议。 最重要的是，我希望能把这套经验推广到其他小餐厅， 用技术真正帮助到更多像我爸一样的个体经营者。 </p></div></div></div></div><div class="github-section" data-v-50f125ac><div class="github-content" data-v-50f125ac><div class="github-info" data-v-50f125ac><h4 data-v-50f125ac>项目资源</h4><p data-v-50f125ac> 完整的Python源代码、数据库文件、配置文件等已上传至GitHub仓库。 同时提供exe安装包，包含完整的运行环境，无需额外配置即可使用。 </p></div><div class="project-buttons" data-v-50f125ac><a href="https://github.com/yourusername/restaurant-expense-system" target="_blank" class="github-repo-btn" data-v-50f125ac><svg class="github-icon" fill="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" data-v-50f125ac></path></svg> 查看完整源码 </a><a href="/downloads/restaurant-system-2025/restaurant-expense-system-installer.zip" download="美莲花餐厅支出管理系统_安装包.zip" class="download-button" data-v-50f125ac><svg class="download-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-50f125ac></path></svg> 下载安装包 </a></div></div></div><div class="back-to-overview-section" data-v-50f125ac><button class="back-overview-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg><span data-v-50f125ac>返回项目概览</span></button></div></section>`);
      } else {
        _push(`<!---->`);
      }
      if (selectedProject.value && selectedProject.value !== "nus-sws-2024" && selectedProject.value !== "mengsheng-2024" && selectedProject.value !== "led-voice-2025" && selectedProject.value !== "restaurant-system-2025" && selectedProject.value !== "mobile-app-2025") {
        _push(`<section class="project-detail" data-v-50f125ac><div class="back-button-container" data-v-50f125ac><button class="back-button" data-v-50f125ac><svg class="back-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-50f125ac></path></svg> 返回项目概览 </button></div><div class="coming-soon" data-v-50f125ac><div class="coming-soon-content" data-v-50f125ac><div class="coming-soon-icon" data-v-50f125ac>🚀</div><h2 class="coming-soon-title" data-v-50f125ac>项目详情即将更新</h2><p class="coming-soon-text" data-v-50f125ac> 该项目的详细信息正在整理中，敬请期待更新。 </p><button class="back-overview-btn" data-v-50f125ac> 返回项目概览 </button></div></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</main>`);
      if (imageModal.value.isOpen) {
        _push(`<div class="image-modal-overlay" data-v-50f125ac><div class="image-modal-content" data-v-50f125ac><button class="modal-close-btn" data-v-50f125ac><svg class="close-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-50f125ac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-50f125ac></path></svg></button>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: imageModal.value.src,
          alt: imageModal.value.title,
          class: "modal-image",
          style: { objectFit: "contain" }
        }, null, _parent));
        _push(`<div class="modal-title" data-v-50f125ac>${ssrInterpolate(imageModal.value.title)}</div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const projects = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-50f125ac"]]);
export {
  projects as default
};
//# sourceMappingURL=projects-C0PDPfri.js.map
